...
from ..tree import tree_kernels_STonlyroot_FeatureVector
...
class ODDCLGraphKernel(GraphKernel):
    """
    Class that implements the ODDKernel with ST kernel
    """
    
    def __init__(self, r = 3, l = 1, normalization = True, hashsz=32):
        """
        Constructor
        ...
        self.__conjsymbol='#'
        self.__endsymbol='?'
        self.treekernelfunction=tree_kernels_STonlyroot_FeatureVector.STKernel(self.Lambda,order='gaussian')
